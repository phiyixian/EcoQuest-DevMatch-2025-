...
const quests = [
    {
      id: 1,
      name: "Find the Lost Mushroom",
      description: "Locate and interact with the magical mushroom in the forest.",
      progress: 0,
      goal: 1,
      completed: false
    },
    {
      ...
      description: "Gather 5 healing herbs scattered around the forest.",
      progress: 0,
      goal: 5,
      completed: false
    }
  ...
  function drawQuestList() {
    ...
    quests.forEach(quest => {
      const status = quest.completed ? "✅" : `${quest.progress}/${quest.goal}`;
